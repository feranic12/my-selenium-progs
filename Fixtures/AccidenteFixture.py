...
class AccidenteFixture(BaseFixture):
    ...
    def fill_frame(self):
        ...
        term_3.click()
        #WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.CSS_SELECTOR, 'div[idname=\"yes\"]')))
        sport = driver.find_element_by_css_selector('div[idname=\"yes\"]')
        sport.click()
        hospital=driver.find_element_by_xpath("//div[@id=\"container-header\"]/div[1]/div[3]/table[1]/tbody[1]/tr[1]/td[2]/div[1]/div[2]")
        hospital.click()
