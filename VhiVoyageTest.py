...
class VhiVoyage():
    ...
    def fill_frame(self):
        ...
        third_number.send_keys("0005")

        last_name=driver.find_element_by_name("lastName")
        last_name.send_keys("Аладышев")

        first_name = driver.find_element_by_name("firstName")
        pyperclip.copy("FirstName14762")
        first_name.send_keys(Keys.LEFT_CONTROL+"v")

        middle_name = driver.find_element_by_name("middleName")
        pyperclip.copy("SecondName14762")
        ...
        WebDriverWait(driver,10).until(EC.element_to_be_clickable((By.CSS_SELECTOR,"div#product-variant-2 div.btn-primary")))
        ...
        surname.send_keys("Martynov")

        given_name=driver.find_element_by_name("Given names")
        given_name.send_keys("Stanislav")
